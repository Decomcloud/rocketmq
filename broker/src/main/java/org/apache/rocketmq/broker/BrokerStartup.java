...
public class BrokerStartup {
    ...
    public static BrokerController createBrokerController(String[] args) {
        ...
        try {
            ...
            // broker需要作为client发送请求到name server
            // 也需要作为client接收来自client的请求
            ...
            // 设置ha高可用监听端口号, 之前设置成了10911, 这里+1为10912
